document.addEventListener('DOMContentLoaded', function() {
    ...
    const careerData = {
        high_performer: [
            ...
            { title: "Software developer", description: "Provide tecnical advice and builds developes solutions for daily life problems", skills: ["Creative Thinking", "Communication"], emoji: "👨‍💻", sector: "Information tecnology" },
        ],
        average_performer: [
            ...
            { title: "Writer", description: "Create visual concepts of different Zoners", skills: ["Creativity", "Soft Skills"], emoji: "✍️", sector: "Creative" },
        ],
        low_performer: [
